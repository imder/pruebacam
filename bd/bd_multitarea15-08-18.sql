...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-08-2018 a las 00:47:38
...
CREATE TABLE `fotografias` (
  ...
  `relev_idRelev` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `fotografias` (`idFoto`, `nom_foto`, `url_foto`, `tipo_img`, `relev_idRelev`) VALUES
...
ALTER TABLE `fotografias`
  ...
  ADD KEY `cable_idCable` (`relev_idRelev`),
  ADD KEY `relev_idRelev` (`relev_idRelev`),
  ADD KEY `relev_idRelev_2` (`relev_idRelev`);
...
ALTER TABLE `relevamientos`
  ...
  ADD KEY `ser_idServ_2` (`ser_idServ`);
...
--
ALTER TABLE `cableado_estructurado`
  MODIFY `idCable` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `relevamientos`
  MODIFY `idRelev` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
...
--
ALTER TABLE `fotografias`
  ADD CONSTRAINT `fk_fotografias_relevamientos` FOREIGN KEY (`relev_idRelev`) REFERENCES `relevamientos` (`idRelev`) ON DELETE CASCADE ON UPDATE CASCADE;
